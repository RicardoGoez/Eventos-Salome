...
export class PedidoService {
  private pedidoRepository: PedidoRepositorySupabase;
  ...
  constructor(
    pedidoRepository: PedidoRepositorySupabase,
  ...
  async listarPorCliente(clienteId: string): Promise<Pedido[]> {
    return this.pedidoRepository.findByCliente(clienteId);
  }

  async listarPorMesa(mesaId: string): Promise<Pedido[]> {
    return this.pedidoRepository.findByMesa(mesaId);
  }
