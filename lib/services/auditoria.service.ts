import { ActividadAuditoriaRepository } from "../repositories/actividad-auditoria.repository";
import { ActividadAuditoria } from "@/types/domain";

export class AuditoriaService {
  private repository: ActividadAuditoriaRepository;

  constructor(repository: ActividadAuditoriaRepository) {
