import { EntradaInventarioRepository } from "../repositories/entrada-inventario.repository";
import { InventarioService } from "./inventario.service";
import { EntradaInventario, TipoMovimientoInventario } from "@/types/domain";

export class EntradaInventarioService {
  private entradaRepository: EntradaInventarioRepository;
  private inventarioService: InventarioService;

  constructor(
    entradaRepository: EntradaInventarioRepository,
